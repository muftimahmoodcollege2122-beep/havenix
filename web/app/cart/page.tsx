    ...
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 py-6 sm:py-8">
      ...
      {cart.items.length === 0 ? (
        <div className="text-center py-24">
          ...
          <Link href="/collections/women" className="bg-espresso text-cream px-7 py-3.5 text-[13px] tracking-widest uppercase hover:bg-ink transition-colors">
            Continue Shopping
          </Link>
        </div>
      ) : (
        <div className="grid md:grid-cols-[1fr_360px] gap-12">
          ...
          <div>
            ...
            <Link href="/collections/women" className="block text-center text-[12px] text-clay underline underline-offset-2 mb-8">
              Continue Shopping
            </Link>
