...
import type { AdminProductInput, AdminVariant } from "@/lib/adminApi";
...
export default function AdminProductForm({ id }: { id?: string }) {
    ...
    <div className="p-4 sm:p-8 max-w-[820px]">
      ...
      <form onSubmit={submit} className="space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/admin/products" className="text-[13px] text-muted hover:text-ink transition-colors">
            Cancel
          </Link>
        </div>
      </form>
