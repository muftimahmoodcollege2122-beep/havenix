    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto grid md:grid-cols-2 items-center gap-8 px-6 pt-10 pb-10">
          <div>
            <div
              className="hero-title-anim text-[12px] tracking-widest uppercase text-clay mb-4 flex items-center gap-2"
            ...
            <h1 className="font-serif text-[42px] md:text-[54px] leading-[1.1] text-ink mb-5">
              <span className="hero-title-anim inline-block" style={{ animationDelay: "0.15s" }}>
                Timeless style
              </span>
              <br />
              <span className="hero-title-anim inline-block" style={{ animationDelay: "0.3s" }}>
                for little hearts.
              </span>
            </h1>
            <p
              className="hero-title-anim text-muted text-[15px] leading-relaxed max-w-md mb-8"
              style={{ animationDelay: "0.45s" }}
            >
              Thoughtfully designed outfits for every adventure, made with love and soft on their world.
            </p>
            <div className="hero-title-anim flex items-center gap-5" style={{ animationDelay: "0.6s" }}>
              <Link
          ...
          <div className="relative aspect-[4/3] overflow-hidden rounded-sm group" style={{ animation: "fadeIn 1.1s ease-out both" }}>
            <img
