...
export default function MockGateway() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1115] flex items-center justify-center px-4 font-body">
      <div className="w-full max-w-sm bg-white rounded-lg overflow-hidden shadow-2xl">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-2 mt-6 text-[11px] text-muted justify-center">
            ...
            This screen stands in for JazzCash / EasyPaisa / card checkout until real
            gateway credentials are connected.
          </div>
        </div>
      </div>
    </div>
